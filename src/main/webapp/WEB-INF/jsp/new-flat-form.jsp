...
<div class="py-5">
    <div class="container w-50">
        ...
        <c:if test="${msg != null}">
            <div class="alert alert-danger col-xs-offset-1 col-xs-10 w-100 text-light"> ${msg} </div>
        </c:if>
        <c:if test="${done != null}">
            <div class="alert alert-success col-xs-offset-1 col-xs-10 w-100 text-light"> ${done} </div>
        </c:if>
        <form action="uploadFlat?${_csrf.parameterName}=${_csrf.token}" method="post"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-4"><label>Surface</label>
                    <input name="surface" type="number" min="5" max="1000" class="form-control text-center text-dark"
                           required="true">
                </div>
                <div class="mb-3 col-md-4"><label>Rooms</label>
                    <input name="rooms" type="number" min="1" max="20" class="form-control text-center text-dark"
                           required="true">
                </div>
            ...
            <div class="mb-3"><label>Description</label>
                <textarea name="content" class="form-control rounded text-center text-dark" rows="3"
